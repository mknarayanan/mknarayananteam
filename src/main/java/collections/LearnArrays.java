...
public class LearnArrays {
	...
	//	System.out.println(mentors[6]); // accessing beyond size, throws exception
		...
		//System.out.println("int array "+weeks[10]);
		...
		System.out.println("The Comparison of the 2 int arrys are: " + "Clone and anotherWeek2: "
		+ Arrays.equals(anotherWeek1, weeks));
